...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(LimpiezaNoEncontradaException ex) {
        ...
        ErrorResponse error = new ErrorResponse(HttpStatus.NOT_FOUND.value(),
                "Recurso no encontrado", ex.getMessage(), LocalDateTime.now());
    ...
    public ResponseEntity<ErrorResponse> handleIllegalArgument(IllegalArgumentException ex) {
        ...
        ErrorResponse error = new ErrorResponse(HttpStatus.BAD_REQUEST.value(),
                "Petición inválida / Estado Erróneo", ex.getMessage(), LocalDateTime.now());
    ...
    public ResponseEntity<ErrorResponse> handleGeneral(Exception ex) {
        ...
        ErrorResponse error = new ErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR.value(),
                ...
                "Ocurrió un error inesperado en el microservicio de Limpieza.",
                LocalDateTime.now());
